...
const generate = async () => {
  ...
  wsPenerimaan.addRow(['01 Januari 2026', 'Januari', 'Ahmad Dahlan', 'Bank', 'Bank Mandiri', 'Zakat Fitrah', 'Individu', 'Individu', 200000, '', '12.5', '', 'Zakat']);
  ...
  wsPenerimaan.addRow(['09 Mei 2026', 'Mei', 'Hamba Allah 2', 'Cash', 'Cash', 'Zakat Fitrah', 'Individu', 'Individu', 45000, '', '12.5', '', 'Zakat']);
  ...
  wsDistribusi.addRow(['05 Januari 2026', 'Bantuan Biaya Hidup Asnaf Fakir', 'Biaya Hidup Sehari-hari', 'Rutin', '111111', 'Budi Santoso', '2171011122334455', 'Jl. Cinta Damai No 1', 'Batu Selicin', 'Lubuk Baja', 500000, 'Bank', 'Individu', 'Batam Peduli', 'Fakir', '', 1, 'Zakat Fitrah', 'Individu', 'Bantuan rutin 1', '081111111111', '', 'diterima']);
  wsDistribusi.addRow(['06 Januari 2026', 'Bantuan Pengobatan Asnaf Miskin', 'Berobat', 'Tidak Rutin', '222222', 'Siti Aminah', '2171019988776655', 'Jl. Harapan Raya No 2', 'Belian', 'Batam Kota', 750000, 'Bank', 'Individu', 'Batam Sehat', 'Miskin', '', 1, 'Zakat Fitrah', 'Individu', 'Bantuan RS', '082222222222', '', 'diterima']);
  wsDistribusi.addRow(['07 Februari 2026', 'Bantuan Syiar Dakwah Asnaf Sabilillah', 'Sinergi Dakwah', 'Tidak Rutin', '333333', 'Rahmat Hidayat', '2171013333333333', 'Jl. Sukajadi Asri 3', 'Sukajadi', 'Batam Kota', 300000, 'Cash', 'Individu', 'Batam Taqwa', 'Fisabillillah', 'Infak Tidak Terikat', 1, 'Zakat Fitrah', 'Individu', 'Operasional Dakwah', '083333333333', '', 'diterima']);
  wsDistribusi.addRow(['08 Februari 2026', 'Bantuan Pelunasan Utang Asnaf Gharimin', 'Pembayaran Hutang', 'Tidak Rutin', '444444', 'Santi Kurnia', '2171014444444444', 'Komp. Muka Kuning 4', 'Muka Kuning', 'Sei Beduk', 1200000, 'Bank', 'Individu', 'Batam Peduli', 'Gharimin', '', 1, 'Zakat Fitrah', 'Individu', 'Pelunasan', '084444444444', '', 'diterima']);
  wsDistribusi.addRow(['09 Maret 2026', 'Bantuan Biaya Hidup Asnaf Ibnu Sabil', 'B. Pemulangan Ibnusabil', 'Tidak Rutin', '555555', 'Bagus Ramadhan', '2171015555555555', 'Jl. Tiban Asri 5', 'Tiban Lama', 'Sekupang', 200000, 'Cash', 'Individu', 'Batam Peduli', 'Ibnu Sabil', '', 1, 'Zakat Fitrah', 'Individu', 'Tiket Pulang', '085555555555', '', 'diterima']);
  wsDistribusi.addRow(['10 Maret 2026', 'Bantuan Penyaluran Fitrah Asnaf Fakir', 'Penyaluran Zakat Fitrah', 'Tidak Rutin', '666666', 'Joko Winarno', '2171016666666666', 'Jl. Melati 6', 'Kampung Pelita', 'Lubuk Baja', 400000, 'Bank', 'Individu', 'Batam Peduli', 'Fakir', '', 1, 'Zakat Fitrah', 'Individu', 'Zakat Fitrah', '086666666666', '', 'diterima']);
  wsDistribusi.addRow(['11 April 2026', 'Bantuan Modal Usaha Asnaf Miskin', 'Modal Usaha', 'Tidak Rutin', '777777', 'Wati Sulastri', '2171017777777777', 'Jl. Bengkong Laut 7', 'Bengkong Laut', 'Bengkong', 800000, 'Cash', 'Individu', 'Batam Makmur', 'Miskin', '', 1, 'Zakat Fitrah', 'Individu', 'Modal Dagang', '087777777777', '', 'diterima']);
  wsDistribusi.addRow(['12 April 2026', 'Bantuan Kafalah/Mukafaah Dai Asnaf Sabilillah', 'Insentif Dai', 'Rutin', '888888', 'Agus Supriyanto', '2171018888888888', 'Jl. Batu Merah 8', 'Batu Merah', 'Batu Ampar', 150000, 'Bank', 'Individu', 'Batam Taqwa', 'Amil', '', 1, 'Zakat Fitrah', 'Individu', 'Insentif Guru', '088888888888', '', 'diterima']);
  wsDistribusi.addRow(['13 Mei 2026', 'Bantuan Pendidikan Dasar dan Menengah Asnaf Miskin', 'B. Masuk SD', 'Tidak Rutin', '999999', 'Yayasan Yatim Piatu', '2171019999999999', 'Jl. Pahlawan 9', 'Belian', 'Batam Kota', 5000000, 'Bank', 'Lembaga', 'Batam Cerdas', 'Fisabillillah', '', 1, 'Zakat Fitrah', 'Lembaga', 'Bantuan Panti', '089999999999', '', 'diterima']);
  wsDistribusi.addRow(['14 Mei 2026', 'Bantuan Operasional Fasilitas Kesehatan Asnaf Miskin', 'Operasional RIB', 'Rutin', '101010', 'Masjid Al-Barkah', '2171010101010101', 'Jl. Masjid Komplek 10', 'Taman Baloi', 'Batam Kota', 3500000, 'Bank', 'Masjid', 'Batam Sehat', 'Fisabillillah', 'Infak Terikat', 1, 'Zakat Fitrah', 'Masjid', 'Bantuan Kas Masjid', '081010101010', '', 'diterima']);
