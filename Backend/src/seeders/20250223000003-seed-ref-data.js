 ...
 * ref_via_distribusi, ref_via_penerimaan, ref_metode_bayar,
...
module.exports = {
  async up(queryInterface) {
    ...
    // 4. ref_via_distribusi
    await queryInterface.bulkInsert('ref_via_distribusi', [
      { nama: 'Cash' },
      { nama: 'Mandiri' },
      { nama: 'BRI' },
      { nama: 'BSI' }
  ...
  async down(queryInterface) {
    ...
    await queryInterface.bulkDelete('ref_via_distribusi',      null, {});
